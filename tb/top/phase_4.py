   ...
   # prev_pc = -1
    ...
    while cycles < 1000:
        ...
        try:
            ...
            if len(history) > 3 and history[-1] == history[-3] and history[-2] == history[-4]:
                match_streak += 1
            else:
                match_streak = 0
    ...
    dut._log.info("To view waveform use \033[34mgtkwave ../cocotb_sim_phase_4/soc_top.fst ../phase4.gtkw\033[0m")
