...
async def loop3_test(dut):
    ...
    dut._log.info("CPU on. Running loop3...")
    ...
    assert return_code == 734, f"Expected x10 == 734, got {return_code}"
    ...
    dut._log.info("SUCCESS - loop3 ran correctly on the CPU!")
